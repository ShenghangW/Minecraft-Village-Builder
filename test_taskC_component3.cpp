...
int main(int argc, char* argv[]) {
    ...
    std::cout << "COMPONENT 3: MOUNTAIN WORLD PATHFINDING" << std::endl;
    ...
    // Mountain terrain needs larger Y range
    int minGroundY = 1000;
    int maxGroundY = 0;
    ...
    minGroundY -= 10;  // Extra buffer for valleys
    maxGroundY += 15;  // Extra buffer for peaks
